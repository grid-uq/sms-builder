...
public class MendeleyRisFileMultipleRegisterParse extends FileMultipleRegisterParse {

	public MendeleyRisFileMultipleRegisterParse( Fuente fuente) {
		super(new MendeleyRisReferenceParcer(fuente));
	}
